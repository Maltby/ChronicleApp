...
def queryTop30():
    ...
    if len(db_instances) != 1:
        raise Exception("There's more than one instance of 'booksmain', this should not occur")
    ...
    if status == 'available':
        ...
        # Limit of 30 to prove functionality
...
def createUrls(bookIdArray):
    ...
    # example 1 : http://aleph.gutenberg.org/1/0/2/7/10274/10274-h.zip
    # example 2 : http://aleph.gutenberg.org/8/84/84-h.zip
    bookUrlArray = []
    for id in bookIdArray:
        # TODO: Not all books will be successfully parsed, work on parsing the HTML
...
def htmlToChapterizedDict(htmlFile, headerString):
    # header input is string equal to 'h1', 'h2', or 'h3' or other
        ...
        while True:
            ...
            if isinstance(nextNode, Tag):
                if nextNode.name == "a":
                    ...
                    dict[chapterCount] = {'Title':title,'Text':chapterTextString}
                    break
                # More than one consecutive spaces will negatively affect transcription
